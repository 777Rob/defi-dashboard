 ...
 * });
 */
export function useGetTokenDayDatasBscQuery(
  baseOptions: Apollo.QueryHookOptions<GetTokenDayDatasBscQuery, GetTokenDayDatasBscQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetTokenDayDatasBscQuery, GetTokenDayDatasBscQueryVariables>(
    GetTokenDayDatasBscDocument,
    options
  );
}
export function useGetTokenDayDatasBscLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetTokenDayDatasBscQuery,
    GetTokenDayDatasBscQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetTokenDayDatasBscQuery, GetTokenDayDatasBscQueryVariables>(
    GetTokenDayDatasBscDocument,
    options
  );
}
export type GetTokenDayDatasBscQueryHookResult = ReturnType<typeof useGetTokenDayDatasBscQuery>;
export type GetTokenDayDatasBscLazyQueryHookResult = ReturnType<
  typeof useGetTokenDayDatasBscLazyQuery
>;
export type GetTokenDayDatasBscQueryResult = Apollo.QueryResult<
  GetTokenDayDatasBscQuery,
  GetTokenDayDatasBscQueryVariables
>;
