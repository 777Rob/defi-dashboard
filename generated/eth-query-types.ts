...
export type Factory = {
  ...
  totalProtocolFeesETH: Scalars['BigDecimal'];
  totalProtocolFeesUSD: Scalars['BigDecimal'];
...
export type Factory_Filter = {
  ...
  totalProtocolFeesETH?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesETH_gt?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesETH_gte?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesETH_in?: InputMaybe<Array<Scalars['BigDecimal']>>;
  totalProtocolFeesETH_lt?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesETH_lte?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesETH_not?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesETH_not_in?: InputMaybe<Array<Scalars['BigDecimal']>>;
  totalProtocolFeesUSD?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesUSD_gt?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesUSD_gte?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesUSD_in?: InputMaybe<Array<Scalars['BigDecimal']>>;
  totalProtocolFeesUSD_lt?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesUSD_lte?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesUSD_not?: InputMaybe<Scalars['BigDecimal']>;
  totalProtocolFeesUSD_not_in?: InputMaybe<Array<Scalars['BigDecimal']>>;
...
export type PancakeDayData = {
  ...
  id: Scalars['ID'];
  protocolFeesUSD: Scalars['BigDecimal'];
...
export type PancakeDayData_Filter = {
  ...
  protocolFeesUSD?: InputMaybe<Scalars['BigDecimal']>;
  protocolFeesUSD_gt?: InputMaybe<Scalars['BigDecimal']>;
  protocolFeesUSD_gte?: InputMaybe<Scalars['BigDecimal']>;
  protocolFeesUSD_in?: InputMaybe<Array<Scalars['BigDecimal']>>;
  protocolFeesUSD_lt?: InputMaybe<Scalars['BigDecimal']>;
  protocolFeesUSD_lte?: InputMaybe<Scalars['BigDecimal']>;
  protocolFeesUSD_not?: InputMaybe<Scalars['BigDecimal']>;
  protocolFeesUSD_not_in?: InputMaybe<Array<Scalars['BigDecimal']>>;
...
export type Pool_Filter = {
  ...
  feeGrowthGlobal1X128_not?: InputMaybe<Scalars['BigInt']>;
  feeGrowthGlobal1X128_not_in?: InputMaybe<Array<Scalars['BigInt']>>;
  feeProtocol?: InputMaybe<Scalars['BigInt']>;
  feeProtocol_gt?: InputMaybe<Scalars['BigInt']>;
  feeProtocol_gte?: InputMaybe<Scalars['BigInt']>;
  feeProtocol_in?: InputMaybe<Array<Scalars['BigInt']>>;
  feeProtocol_lt?: InputMaybe<Scalars['BigInt']>;
  feeProtocol_lte?: InputMaybe<Scalars['BigInt']>;
  feeProtocol_not?: InputMaybe<Scalars['BigInt']>;
  feeProtocol_not_in?: InputMaybe<Array<Scalars['BigInt']>>;
...
export type Swap_Filter = {
  ...
  amount1_not?: InputMaybe<Scalars['BigDecimal']>;
  amount1_not_in?: InputMaybe<Array<Scalars['BigDecimal']>>;
  amountFeeUSD?: InputMaybe<Scalars['BigDecimal']>;
  amountFeeUSD_gt?: InputMaybe<Scalars['BigDecimal']>;
  amountFeeUSD_gte?: InputMaybe<Scalars['BigDecimal']>;
  amountFeeUSD_in?: InputMaybe<Array<Scalars['BigDecimal']>>;
  amountFeeUSD_lt?: InputMaybe<Scalars['BigDecimal']>;
  amountFeeUSD_lte?: InputMaybe<Scalars['BigDecimal']>;
  amountFeeUSD_not?: InputMaybe<Scalars['BigDecimal']>;
  amountFeeUSD_not_in?: InputMaybe<Array<Scalars['BigDecimal']>>;
  amountUSD?: InputMaybe<Scalars['BigDecimal']>;
  amountUSD_gt?: InputMaybe<Scalars['BigDecimal']>;
  amountUSD_gte?: InputMaybe<Scalars['BigDecimal']>;
  amountUSD_in?: InputMaybe<Array<Scalars['BigDecimal']>>;
...
export type GetPairDayDatasEthQueryVariables = Exact<{
...
/**
 * __useGetPairDayDatasEthQuery__
 *
 * To run a query within a React component, call `useGetPairDayDatasEthQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPairDayDatasEthQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPairDayDatasEthQuery({
 *   variables: {
 *      pairAddress: // value for 'pairAddress'
 *   },
 * });
 */
export function useGetPairDayDatasEthQuery(baseOptions: Apollo.QueryHookOptions<GetPairDayDatasEthQuery, GetPairDayDatasEthQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPairDayDatasEthQuery, GetPairDayDatasEthQueryVariables>(GetPairDayDatasEthDocument, options);
      }
export function useGetPairDayDatasEthLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPairDayDatasEthQuery, GetPairDayDatasEthQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPairDayDatasEthQuery, GetPairDayDatasEthQueryVariables>(GetPairDayDatasEthDocument, options);
        }
